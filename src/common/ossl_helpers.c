...
static void fetch_ossl_objects(void) {
	sha256_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA256", NULL));
	sha384_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA384", NULL));
	sha512_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA512", NULL));

	sha3_256_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA3-256", NULL));
	sha3_384_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA3-384", NULL));
	sha3_512_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHA3-512", NULL));
	shake128_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHAKE128", NULL));
	shake256_ptr = OSSL_FUNCALL(EVP_MD_fetch(NULL, "SHAKE256", NULL));

	aes128_ecb_ptr = OSSL_FUNCALL(EVP_CIPHER_fetch(NULL, "AES-128-ECB", NULL));
	aes256_ecb_ptr = OSSL_FUNCALL(EVP_CIPHER_fetch(NULL, "AES-256-ECB", NULL));
	aes256_ctr_ptr = OSSL_FUNCALL(EVP_CIPHER_fetch(NULL, "AES-256-CTR", NULL));
...
static void free_ossl_objects(void) {
	OSSL_FUNCALL(EVP_MD_free(sha256_ptr));
	sha256_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(sha384_ptr));
	sha384_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(sha512_ptr));
	sha512_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(sha3_256_ptr));
	sha3_256_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(sha3_384_ptr));
	sha3_384_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(sha3_512_ptr));
	sha3_512_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(shake128_ptr));
	shake128_ptr = NULL;
	OSSL_FUNCALL(EVP_MD_free(shake256_ptr));
	shake256_ptr = NULL;
	OSSL_FUNCALL(EVP_CIPHER_free(aes128_ecb_ptr));
	aes128_ecb_ptr = NULL;
	OSSL_FUNCALL(EVP_CIPHER_free(aes256_ecb_ptr));
	aes256_ecb_ptr = NULL;
	OSSL_FUNCALL(EVP_CIPHER_free(aes256_ctr_ptr));
	aes256_ctr_ptr = NULL;
}
...
const EVP_MD *oqs_sha256(void) {
	...
	return sha256_ptr;
#else
	return OSSL_FUNCALL(EVP_sha256());
#endif
}
...
const EVP_MD *oqs_sha384(void) {
	...
	return sha384_ptr;
#else
	return OSSL_FUNCALL(EVP_sha384());
#endif
}
...
const EVP_MD *oqs_sha512(void) {
	...
	return sha512_ptr;
#else
	return OSSL_FUNCALL(EVP_sha512());
#endif
}
...
const EVP_MD *oqs_shake128(void) {
	...
	return shake128_ptr;
#else
	return OSSL_FUNCALL(EVP_shake128());
#endif
}
...
const EVP_MD *oqs_shake256(void) {
	...
	return shake256_ptr;
#else
	return OSSL_FUNCALL(EVP_shake256());
#endif
}
...
const EVP_MD *oqs_sha3_256(void) {
	...
	return sha3_256_ptr;
#else
	return OSSL_FUNCALL(EVP_sha3_256());
#endif
}
...
const EVP_MD *oqs_sha3_384(void) {
	...
	return sha3_384_ptr;
#else
	return OSSL_FUNCALL(EVP_sha3_384());
#endif
}
...
const EVP_MD *oqs_sha3_512(void) {
	...
	return sha3_512_ptr;
#else
	return OSSL_FUNCALL(EVP_sha3_512());
#endif
}
...
#else
	return OSSL_FUNCALL(EVP_aes_128_ecb());
#endif
}
...
#else
	return OSSL_FUNCALL(EVP_aes_256_ecb());
#endif
}
...
#else
	return OSSL_FUNCALL(EVP_aes_256_ctr());
#endif
}
